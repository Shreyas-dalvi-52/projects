...
if (isset($_POST['submit'])) 
{
    ...
    $query="update DONOR set NAME='$name',DOB='$dob',BGROUP='$bg',AADHAR='$aadhar',STATUS='COMPLETED',MOB='$mob',AADHAR_PIC='$file_name',GENDER='$gender',DISTRICT='$dist' where id='$id'";
