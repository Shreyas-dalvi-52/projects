...
$id=$_GET['id'];
$sql="SELECT * FROM STAFF_MAN where ID='$id'";
...
background-color: #594f8d;
	...
	<body>
		<form method="POST">
			...
			<div class="header">
				<center>
				<h1><center>Staff Information</h1>
		...
		<br>
				...
				<input type="text" id="fname" name="fname" style="height:40px;" value="<?php echo $row['fname']?>" pattern="^(\w\w+)\s(\w+)$" required/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

				<label><b>Mobile No</b><font color="red">*</font></label>
				<input type="tel" id="mobileno" name="mobileno" value="<?php echo $row['mobileno']?>" pattern="[0-9]{10}" required/>
				<br><br>

				&nbsp;&nbsp;<label><b>Email</b><font color="red">*</font></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="email" id="s_email" value="<?php echo $row['s_email']?>" name="s_email" required/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label><b>Date Of Birth<b><font color="red">*</font></label>
				<input type="date" id="dob" value="<?php echo $row['dob']?>"name="dob" required/>
				<br><br>				
			 ...
			 <select class="s1" name="designation" id="designation"> 
				...
				<option value="Volunteer" <?php if($row['designation'] == 'Volunteer') echo 'selected'; ?>>Volunteer</option> 
			</select>
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

				<label><b>Joining Date</b><font color="red">*</font></label>&nbsp;
				<input type="date" id="jd" value="<?php echo $row['jd']?>"name="jd" required/><br><br><br>
				<script>
  window.onload = function() {
    
    var shiftValue = "<?php echo $row['shift']?>"
    var shiftRadios = document.getElementsByName('shift');

    for (var i = 0; i < shiftRadios.length; i++) {
      if (shiftRadios[i].value === shiftValue) {
        shiftRadios[i].checked = true;
        break;
      }
    }
  }
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				&nbsp;&nbsp;
				<input type="number" value="<?php echo $row['salary']?>"id="salary" name="salary"  pattern="[0-9]"required/><br><br>

			
				<center>
		    <input type="submit" id="submit" name="submit" value="SUBMIT">
		    <input type="button" name="back" id="back" class="btn"  value="BACK"  onclick="a()" /></center>
				</center>
    ...
    // document.getElementById('email').removeAttribute("required");  
	   window.location.href="newmange_staff1.php";
    }
</script>
<?php
if(isset($_POST['submit']))
	...
	echo "<script>alert('Data Submitted Successfully!');window.location='newmange_staff1.php'</script>";
    } 
?>
	</body>
</html>