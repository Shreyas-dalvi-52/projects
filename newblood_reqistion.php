...
<div class="container" id="">
        ...
        <table class="table table-bordered table-striped">
            <!-- Your table header and data rows here -->
            <thead>
                <tr>
                    <th>PATIENT NAME</th>
                    <th>HOSPITAL NAME</th>
...
<td><?php echo $row["Bloodgroup"];$bg=$row['Bloodgroup'];$bg=str_replace('+','p',$bg);$bg=str_replace('-','n',$bg)?></td>
<td><?php echo $row["BloodQuantity"];?></td>
<td><?php echo $row["Date"];?></td>
<td><?php echo $row["Reason"];?></td>
<td><a style="text-decoration: none;">
	<IMG SRC="images_aadhar\<?php echo $row['Requisition']?>" onmouseover="zoom(this.src)" onmouseout="shrink()"   style="width:100%;height:50px;"></a></td>
<td><a href="approve_blood.php?id=<?php echo $row['ID'] ?>
    &email=<?php echo $row['Email']?>&bg=<?php echo $bg?>&bq=<?php echo $row['BloodQuantity']?>  "style="text-decoration: 
none;">APPROVE</a></td>  
<td><a href="reject_blood.php?id=<?php echo $row['ID'] ?>&email=<?php echo $row['Email'] ?>&bq=<?php echo $row['BloodQuantity']?> &bg=<?php echo $bg?>"style="text-decoration: none;">REJECT</a></td> 
