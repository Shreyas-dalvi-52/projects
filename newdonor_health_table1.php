    ...
    <script>
        ...
        <table style="border: 1px solid black;"class="table table-bordered table-striped">
            ...
            <?php
                ...
                $q= "select * from DONATE_BLOOD where DONATION_STATUS='UNSEEN' and STATUS='APPROVED'";
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="donor_health.php?ID=<?php echo $row['ID'];?>"style="text-decoration: none;">HEALTH CHECKUP</a></td> 
                    </tr>
