 ...
 <div class="container">
        ...
        <table style="border: 1px solid black;" class="table table-bordered table-striped">
            ...
            <?php
                ...
                $q= "select * from DONOR where STATUS='COMPLETED'";
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="verify_donor.php?id=<?php echo $row['ID'];?>&email=<?php echo $row['EMAIL'];?>"style="text-decoration: none;">VERIFY</a></td> 
