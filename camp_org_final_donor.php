 ...
 <center> 
    ...
    <h1 style="color:white; font-style: bold;"> Camp Organization Form </h1>          
     ...
     <div class="input-box">
      ...
      <div class="inputbutton">
        ...
        <input type="button" style="color:white" value="Back" id="home" name="home" onclick="window.location.href='user_dash.php'">
      </div>
  ...
  if(isset($_POST['submit']) && $_POST['flag']==0)
  {
    ...
    $conn=mysqli_connect("localhost","root","","CPE");
      ...
      if($res)
{    echo "<script>alert('form submitted');window.location='camp_org_final2_donor.php?id=$id';</script>";
} 
else{
  $sql="delete from camp where id=$id";
  $res=mysqli_query($conn,$sql);
