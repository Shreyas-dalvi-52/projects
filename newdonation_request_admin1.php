        ...
        <div class="container">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="donation_approve.php?id=<?php echo $row['ID'] ?>&email=<?php echo $row['EMAIL'] ?>" style="text-decoration: none;">APPROVE</a></td>
                    <td><a href="donation_reject.php?id=<?php echo $row['ID'] ?>&email=<?php echo $row['EMAIL'] ?>" style="text-decoration: none;">REJECT</a></td>
                </tr>
