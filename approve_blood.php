...
$q="update hospitalemergency set STATUS='APPROVED',Date=now() where ID='$id'";
...
if($cnt>0){
    ...
    $query_avail="update hospitalemergency set Given_bg='$avail_bg' where ID='$id'";
    $res_avail=mysqli_query($conn,$query_avail);
