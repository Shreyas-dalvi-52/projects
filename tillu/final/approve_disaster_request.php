...
$q="update disasteremergency set STATUS='APPROVED' where ID='$id'";
$res=mysqli_query($conn,$q);
$to_email=$_GET['email'];

include('smtp/PHPMailerAutoload.php');
$msg="Your request of blood(Disaster) is approved by Admin ";
...
function smtp_mailer($to,$subject,$msg){
	...
	if(!$mail->Send()){
		...
		window.location.href='disaster_request_admin1.php'</script>";
	}
}
