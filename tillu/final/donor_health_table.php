    ...
    <div class="sidebar">
        ...
        <ul>
         ...
         <li><a style="text-decoration:none;" href="hospital_request_admin.php">Blood Requests    (Hospital)</a></li>
            ...
            <li><a style="text-decoration:none;" href="donorHealth.php">Health checkup</a></li>
            ...
            <?php
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="donorHealth.php?name=<?php echo $row['NAME'];?>&mob=<?php echo $row['MOB_NO'];?>"style="text-decoration: none;">NEXT</a></td> 
                    </tr>
