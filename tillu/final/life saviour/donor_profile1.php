<?php
	 ...
	 $uname=$_GET['name'];
$q="select * from donor where DNAME='".$uname."'";
...
<div class="card">
 ...
 $o=mysqli_query($con,$q);
      ...
      {
      ?>
<img src="<?PHP ECHO $row['PROFILE_PIC']?>" id="thumb">
  <h2>Life Saviour</h2>
<?php
}
?>
    <div class="area">
     <label>Name:</label>
	 <input type="text" name="user" id="user" readonly value='<?php echo $a; ?>'  style="border:none; border-bottom:1px solid black; outline:none; width:70%;display:inline-block; verticle-align:top;"><br><br>
	  <label>Blood Group:</label>
	 <input type="text" name="blood" id="blood" readonly value='<?php echo $b; ?>'  style="border:none; border-bottom:1px solid black; outline:none; width:70%;display:inline-block; verticle-align:top;"><br><br>
		  <label>DOB:</label>
	 <input type="text" name="date" id="date"  readonly value='<?php echo $c; ?>' style="border:none; border-bottom:1px solid black; outline:none; width:70%;"><br><br>
	<label>Email:</label>
	 <input type="email" name="email" id="email" readonly value='<?php echo $d; ?>'  style="border:none; border-bottom:1px solid black; outline:none; width:70%;"><br><br>
  	  <label>MOB NO:</label>
	 <input type="number" name="mob" id="mob" readonly value='<?php echo $e; ?>'  style="border:none; border-bottom:1px solid black; outline:none; width:70%;"><br><br>

  </div><br><br><br><br><br><br><br><br><br><br><br>
   <input type="submit" name="back" id="back" class="btn"  value="BACK"  /></center>
  </article>
</div>
</form>
...
<?php
  if(isset($_POST['back']))
{
    echo"<script>window.location.href='donor_dash.php'</script>";
}
?>