...
<form method="POST">
    ...
    <input type="text" name="count" id="count" style="height:90px; width: 90px; border:2px; border-style: solid; font-size: 70px; text-align: center; background-color: floralwhite;" value="0"readonly />
     ...
     <input type="text" name="name" id="name" style="width:200px; font-size: 18px;" readonly/>
     <br><br><br>
     ...
     <input type="date" name="DOB" id="DOB" style="text-align:center; font-size: 18px;" readonly/>

     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; 

     <label for="Email" style="font-size:18px;color:darkred;">DONOR EMAIL-ID :</label>
     <input type="email" name="Email" id="Email" style="width:200px; font-size: 18px;" readonly/> 

     <br><br><br><br>
     <center>
     <input type="submit" name="submit" id="submit" value="EDIT PROFILE" style="background-color:firebrick; color: white;font-size:18px;"/>
    </center>
    </div>
</form>
...
if (isset($_POST['submit'])) 
      {
          echo "<script> window.location.href='editdonorProfile.php'</script>";
       }
?>
</html>